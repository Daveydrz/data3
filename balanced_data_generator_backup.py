...
class LifeJourneyTemplate(BalancedTemplate):
    ...
    def create_content(self, needed_entities, needed_relations):
        ...
        if first_person:
            ...
            relations = [
                (RelationTypes.THINKS, "pronoun_i", "stage1"),
                (RelationTypes.REMEMBERS, "pronoun_i", "memory1"),
                (RelationTypes.LEARNS, "pronoun_i", "culture1"),
                (RelationTypes.REFLECTS_ON, "pronoun_i", "period1"),
                (RelationTypes.IMPROVES, "pronoun_i", "growth1"),
                (RelationTypes.FEELS, "pronoun_i", "sentiment1"),
                (RelationTypes.HAPPENS_ON, "memory1", "period1")
            ]
        else:
            # Third person variation
...
class RelationshipDynamicsTemplate(BalancedTemplate):
    ...
    def create_content(self, needed_entities, needed_relations):
        ...
        if first_person:
            ...
            relations = [
                (RelationTypes.MAINTAINS_RELATIONSHIP, "pronoun_i", "person2"),
                (RelationTypes.HAS_TRAIT, "pronoun_i", "trait1"),
                (RelationTypes.FEELS_EMOTION, "pronoun_i", "emotion1"),
                (RelationTypes.MEMBER_OF, "pronoun_i", "group1"),
                (RelationTypes.IS_TYPE, "rel1", "reltype1"),
                (RelationTypes.CARES_FOR, "pronoun_i", "person2"),
                (RelationTypes.SUPPORTS, "pronoun_i", "person2")
            ]
        else:
            # Third person variation  
